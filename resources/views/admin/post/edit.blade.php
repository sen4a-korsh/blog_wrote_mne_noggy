                        ...
                        <div class="col-12 mt-3 p-4">
                            <form action=" {{ route('admin.post.update', $post->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group w-50">
                                    <label for="exampleInputFile">Edit preview:</label>
                                    <div class="w-25 mb-3">
                                        <img src="{{ Storage::url($post->preview_image) }}" height="200px" alt="preview_image">
                                    </div>
                                ...
                                <div class="form-group w-50">
                                    <label for="exampleInputFile">Edit main image:</label>
                                    <div class="w-25 mb-3">
                                        <img src="{{ Storage::url($post->main_image) }}" height="200px" alt="main_image">
                                    </div>
                                    <div class="input-group">
                                        <div class="custom-file">
